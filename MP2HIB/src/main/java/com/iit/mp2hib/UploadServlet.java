...
public class UploadServlet extends HttpServlet {
    ...
    public boolean dataPersist(String loadFile) {
        ...
        try {
            ...
            Session em = null;
            String path = "C:\\Users\\Admin\\Documents\\NetBeansProjects\\MP2HIB\\src\\main\\resources\\com\\iit\\mp2hib\\hibernate.cfg.xml";
...
/*
            ...
            SQLQuery query = em.createSQLQuery(regionQuery);
            ...
            SQLQuery query1 = em.createSQLQuery(stateQuery);
            System.out.println("I git it:");
